...
class Noentregados extends Component
{
    public $arrPedidos = array();

    public function render()
    {
        return view('livewire.entregas.noentregados')->extends('layouts.app');
    }
    ...
    {
        $this->emit('loading');
        $this->arrPedidos = $this->noentregados();

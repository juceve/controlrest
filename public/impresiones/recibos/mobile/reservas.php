...
<div class="ticket">
        ...
        foreach ($detalles as $detalle) {
            ...
            echo '<br><div style="align-content: center; margin-bottom: 10px;">';
            ...
            echo '<td style="width: 50%;">' . $recibo[0] . '</td></tr style="border: hidden;"><tr><td align="right" style="width: 50%;vertical-align:top;"><strong>ESTUDIANTE:</strong></td>';
            echo '<td style="width: 50%;">' . $recibo[1] . '</td></tr><tr style="border: hidden;"><td align="right"><strong>CURSO:</strong></td>';
            echo '<td>' . $recibo[2] . '</td></tr></table><div> ';
            $i = 1;
        ...
        <td>$recibo[3]</td>
        <td align='center'> $recibo[4]</td>
        <td align='center'> $recibo[5]</td>
        <td align='center'>$datosventa[3]</td>
        <td align='center'> $recibo[7]</td>
        <td align='right'>" . number_format($recibo[6], 2, '.', ',') . "</td>
        </tr>";
            $total = $total + $recibo[6];
            $i++;

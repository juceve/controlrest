                ...
                <div class="collapse" id="pagos">
                    <ul class="side-nav-second-level">
                        ...
                        @can('pagos.profesores')
                            <li>
                                <a href="{{ route('pagos.profesores') }}"><i class="uil-receipt"></i> Credito
                                    Profesores</a>
                            </li>
                        @endcan
                        @can('pagos.sincomprobante')
                            <li>
                                <a href="{{ route('pagos.sincomprobante') }}"><i class="uil-receipt"></i> Sin
                                    comprobante</a>
                            </li>
                        @endcan
                    </ul>
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="menus">
                    <ul class="side-nav-second-level">
                        @can('menus.eventos')
                            <li>
                                <a href="{{ route('programarmenu') }}"><i class="uil-calendar-alt"></i> Programa
                                    Semanal</a>
                            </li>
                        @endcan
                        @can('menus.index')
                        ...
                        @can('menus.create')
                            <li>
                                <a href="{{ route('elaborarmenu', ['id' => 0, 'dup' => 0]) }}"><i class="uil-plus"></i>
                                    Nuevo</a>
                            </li>
                        @endcan
                    </ul>
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="reportes">
                    <ul class="side-nav-second-level">
                        {{-- @can('reportes.diario') --}}
                        <li>
                            <a href="{{ route('reportes.diario') }}"><i class="uil-file-alt"></i> Control
                                Almuerzos</a>
                        </li>
                        {{-- @endcan --}}
                        {{-- @can('ventas.vpagos') --}}
                        ...
                        <li>
                            <a href="{{ route('reportes.entregasprofesores') }}"><i class="uil-receipt"></i> Entregas
                                a Profesores</a>
                        </li>
                        {{-- @endcan --}}
                    </ul>
                    ...
                    <div class="collapse" id="Parametros">
                        <ul class="side-nav-second-level">
                            ...
                            @can('nivelcursos.index')
                                <li>
                                    <a href="{{ route('nivelcursos.index') }}"><i class="uil-notebooks"></i> Niveles
                                        Curso</a>
                                </li>
                            @endcan
                            @can('precios.index')

                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 form-group mb-2">
                                ...
                                <?php
                                $comprobante = '';
                                if ($venta->tipopago_id == 2 || $venta->tipopago_id == 3) {
                                    $pago = $venta->pagos;
                                    if ($pago) {
                                ...
                                @if ($comprobante)
                                    <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#modalComprobante"><small>Comprobante</small></button>
                                @endif
                            </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($venta->detalleventas as $dventa)
                                        <tr align="center">
                                            ...
                                            <td>{{ $dventa->observaciones ? $dventa->observaciones : 'Sin observaciones' }}
                                            </td>
                                        </tr>
                                        @php
                                            $i++;
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <img src="{{ asset($comprobante) }}" class="img-fluid" style="width: 100%">
                </div>

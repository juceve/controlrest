                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-info" data-bs-toggle="modal"
                                            data-bs-target="#estudiantes" wire:click='resetAll'>Buscar Clientes <i
                                ...
                                <div class="col-12 col-md-6 border">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <div class="form-check mb-2">
                                            ...
                                            <label class="form-check-label" for="rb{{ $formapago->id }}">{{
                                                $formapago->nombre }}</label>
                                        </div>
                                        @endforeach
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control form-control-sm" value=""
                                                        wire:model='observaciones'></td>
                                            </tr>
                                            <tr>
                                                <td style="vertical-align: middle">IMPORTE {{ $moneda->abreviatura }}
                                                </td>
                                ...
                                <tr style="vertical-align: middle">
                                    ...
                                    <td>
                                        <div class="form-check">
                                            <input type="checkbox" wire:model="checks" id="cb{{ $estudiante->id }}"
                                                class="form-check-input" value="{{ $estudiante->id }}">
